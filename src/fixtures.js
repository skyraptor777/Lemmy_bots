...
exports.get_list_of_fixtures = void 0;
...
function send_fixtures(list_of_fixtures) {
...
function get_type_of_fixture(home_team) {
    if (home_team == 33) {
        return "H";
    }
    else {
...
function get_score(home_goal, away_goal) {
...
async function get_fixtures() {
    ...
    axios
        ...
        const markdown_response = send_fixtures(formatted_response);
...
//format_fixtures('');
get_fixtures();
async function get_list_of_fixtures() {
    const promise_1 = new Promise((resolve, reject) => {
        resolve(get_fixtures());
    });
    promise_1.then(value => {
        console.log(`Exporting Value ${output_to_export}`);
        return output_to_export;
    });
    return output_to_export;
}
exports.get_list_of_fixtures = get_list_of_fixtures;
